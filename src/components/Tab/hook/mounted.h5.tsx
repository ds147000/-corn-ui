...
// 滚动tabBar横向展示区域
const useTabScroll = (el: React.MutableRefObject<HTMLDivElement>, currenIndex: number): void => {
  ...
  useEffect(() => {
    ...
    if (currenIndex > stopIndex) {
      ...
      const move = activeItem.offsetLeft - (el.current.clientWidth / widthPI) + (activeItem.offsetWidth / widthPI)
