...
<li>组件目录必须存在<code><span class="hljs-attribute">demo</span></code>文件夹，存放组件说明的<code><span class="hljs-built_in">md</span></code>文件。<a href="./md">组件md文件编写规范</a>。用于生产UI在线说明文档。</li>
</ul>
